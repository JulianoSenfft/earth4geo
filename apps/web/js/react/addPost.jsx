                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">Adicionar nova publicação</h4>
                            </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                ...
                                                <input type="text" className="form-control" id="cep" placeholder="Digite o cep"></input>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-md-6">
                            ...
                            <div className="modal-footer">
                                <button onClick={this.addPost} id="button-add-post" type="submit" className="btn btn-default align-left">Publicar</button>
